// Marks for the coding agents parsec routes. Inlined SVGs — the static
// export ships no icon library. Paths render in currentColor and each mark
// is colored by its `text-brand-*` token (globals.css "tool marks" block):
// the logos keep their ORIGINAL brand colors, never our palette — same
...
// label, so they stay aria-hidden.
