...
class TraceScorer:
    def __init__(self, bundle: Bundle):
        ...
        backend = os.environ.get("DASEIN_EMBED_BACKEND", "dasein")
    ...
    def _het_readout(self, chunks, decided_idx, recent, task_text, age, emb, cur_step,
        ...
        # DASEIN-PATCH: ALWAYS emit the changeprone col (zeros when the sidecar is absent) — the
        ...
        # DASEIN-PATCH: scout block likewise always present — AC_SCOUTFEAT is pinned truthy ("on"
