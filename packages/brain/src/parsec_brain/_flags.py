...
import time. `parsec_brain/__init__.py` imports it first so any
`parsec_brain.*` import gets the pins; scorer/bundle/app import it explicitly
as well.
...
PINS = {
    ...
    "AC_TARGET_COV": "0.70",     # serving operating point (bundle prefers PARSEC_TARGET_COV)
}
