# Parsec plugin marketplace

Claude Code plugin marketplace for [Parsec](https://getparsec.ai). This repo is
...
`plugins/parsec` — markdown/JSON plugin surfaces plus prebuilt `parsec`
