...
Dark and light are one system: same names, same components, only values swap.
Apply with `data-theme="light"`; it also auto-applies under
`prefers-color-scheme: light` (see `tokens/theme.css`, toggle in
`tokens/theme-toggle.js`). The neon phosphor darkens to a contrast-safe emerald
on white; the glow becomes a soft shadow.

| Role | Dark | Light (Paper) |
|---|---|---|
| background | `#0A0E0C` | `#F2F5F1` |
| surface | `#0F1512` | `#FFFFFF` |
| elevated | `#131B17` | `#FBFDFA` |
| border | `#1D2A22` | `#DCE6DE` |
| text | `#D7FBE4` | `#0C1410` |
| text-muted | `#8CA897` | `#516358` |
| primary / accent | `#4AF626` | `#17833A` |
| on-primary | `#06210B` | `#FFFFFF` |
| logo green | `#4AF626` | `#2FA317` |
| success | `#4AF626` | `#17833A` |
| warning | `#FFB84D` | `#B7791F` |
| error | `#FF5C57` | `#C6362F` |
| info / link | `#4AD0E0` | `#0E7490` |
